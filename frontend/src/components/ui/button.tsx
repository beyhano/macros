...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-zinc-400 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-zinc-600",
  {
    variants: {
      variant: {
        default:
          "bg-zinc-900 text-zinc-50 shadow hover:bg-zinc-700 dark:bg-zinc-50 dark:text-zinc-900 dark:hover:bg-zinc-200",
        destructive:
          "bg-red-600 text-zinc-50 shadow-sm hover:bg-red-500 dark:bg-red-700 dark:hover:bg-red-600",
        outline:
          "border border-zinc-300 bg-transparent shadow-sm hover:bg-zinc-100 dark:border-zinc-600 dark:hover:bg-zinc-800",
        secondary:
